...
#docker pull nginx
#docker images
#docker tag nginx d-reg:5000/develop/nginx
#docker push d-reg:5000/develop/nginx
...
curl --head -H application/vnd.docker.distribution.manifest.v2+json --cacert /etc/docker/certs.d/d-reg\:5000/ca.crt -X GET https://d-reg:5000/v2/develop/nginx/manifests/latest 
